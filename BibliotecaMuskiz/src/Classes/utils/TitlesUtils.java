...
public class TitlesUtils {
    ...
    public static void tituloNuevoAutor(){
        System.out.println(ColoresUtils.VERDE + "     __                           _         _             " + ColoresUtils.RESET);
        System.out.println(ColoresUtils.VERDE + "  /\\ \\ \\_   _  _____   _____     /_\\  _   _| |_ ___  _ __ " + ColoresUtils.RESET);
        System.out.println(ColoresUtils.VERDE + " /  \\/ / | | |/ _ \\ \\ / / _ \\   //_\\\\| | | | __/ _ \\| '__|" + ColoresUtils.RESET);
        System.out.println(ColoresUtils.VERDE + "/ /\\  /| |_| |  __/\\ V / (_) | /  _  \\ |_| | || (_) | |   " + ColoresUtils.RESET);
        System.out.println(ColoresUtils.VERDE + "\\_\\ \\/  \\__,_|\\___| \\_/ \\___/  \\_/ \\_/\\__,_|\\__\\___/|_|   " + ColoresUtils.RESET);
    }
    public static void tituloNuevoLibro(){
        System.out.println(ColoresUtils.VERDE + "     __                           __ _ _               " + ColoresUtils.RESET);
        System.out.println(ColoresUtils.VERDE + "  /\\ \\ \\_   _  _____   _____     / /(_) |__  _ __ ___  " + ColoresUtils.RESET);
        System.out.println(ColoresUtils.VERDE + " /  \\/ / | | |/ _ \\ \\ / / _ \\   / / | | '_ \\| '__/ _ \\ " + ColoresUtils.RESET);
        System.out.println(ColoresUtils.VERDE + "/ /\\  /| |_| |  __/\\ V / (_) | / /__| | |_) | | | (_) |" + ColoresUtils.RESET);
        System.out.println(ColoresUtils.VERDE + "\\_\\ \\/  \\__,_|\\___| \\_/ \\___/  \\____/_|_.__/|_|  \\___/ " + ColoresUtils.RESET);
    }
    public static void tituloEliminarAutor(){
        System.out.println(ColoresUtils.ROJO + "   __ _ _           _                      _         _             " + ColoresUtils.RESET);
        System.out.println(ColoresUtils.ROJO + "  /__\\ (_)_ __ ___ (_)_ __   __ _ _ __    /_\\  _   _| |_ ___  _ __ " + ColoresUtils.RESET);
        System.out.println(ColoresUtils.ROJO + " /_\\ | | | '_ ` _ \\| | '_ \\ / _` | '__|  //_\\\\| | | | __/ _ \\| '__|" + ColoresUtils.RESET);
        System.out.println(ColoresUtils.ROJO + "//__ | | | | | | | | | | | | (_| | |    /  _  \\ |_| | || (_) | |   " + ColoresUtils.RESET);
        System.out.println(ColoresUtils.ROJO + "\\__/ |_|_|_| |_| |_|_|_| |_|\\__,_|_|    \\_/ \\_/\\__,_|\\__\\___/|_|   " + ColoresUtils.RESET);
    }
    public static void tituloEliminarLibro(){
        System.out.println(ColoresUtils.ROJO + "   __ _ _           _                      __ _ _               " + ColoresUtils.RESET);
        System.out.println(ColoresUtils.ROJO + "  /__\\ (_)_ __ ___ (_)_ __   __ _ _ __    / /(_) |__  _ __ ___  " + ColoresUtils.RESET);
        System.out.println(ColoresUtils.ROJO + " /_\\ | | | '_ ` _ \\| | '_ \\ / _` | '__|  / / | | '_ \\| '__/ _ \\ " + ColoresUtils.RESET);
        System.out.println(ColoresUtils.ROJO + "//__ | | | | | | | | | | | | (_| | |    / /__| | |_) | | | (_) |" + ColoresUtils.RESET);
        System.out.println(ColoresUtils.ROJO + "\\__/ |_|_|_| |_| |_|_|_| |_|\\__,_|_|    \\____/_|_.__/|_|  \\___/ " + ColoresUtils.RESET);
    }
